...
import { ProductionReadinessRouteSkeleton } from "@/components/design-system/loading/route-skeletons";
import type { RouteSkeletonScope } from "@/lib/ui/route-skeleton-scope";

export function ProductionReadinessPageStructure({
  mode = "skeleton",
  scope = "full",
}: {
  mode?: SkeletonMode;
  ...
  return <ProductionReadinessRouteSkeleton scope={scope} />;
}
