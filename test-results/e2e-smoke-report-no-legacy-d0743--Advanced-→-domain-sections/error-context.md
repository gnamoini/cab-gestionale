...
- Name: e2e\smoke\report-no-legacy.spec.ts >> Report P9 — no legacy surface >> Executive → Advanced → domain sections
- Location: e2e\smoke\report-no-legacy.spec.ts:17:7
