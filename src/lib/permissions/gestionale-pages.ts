...
import {
  ...
  IconNavDocumenti,
  IconNavFatturazione,
  IconNavIdentificaRicambio,
  IconNavLavorazioni,
  IconNavLavorazioniClient,
  IconNavMagazzino,
  IconNavMezzi,
  IconNavOrdiniFornitori,
  IconNavPreventivi,
  IconNavReport,
  IconNavSecurity,
  IconNavSettings,
...
export const GESTIONALE_PAGES = [
  ...
  },
  {
    ...
    expandableModules: ["ddt"],
  },
  {
    key: "ordini_fornitori",
    href: "/ordini-fornitori",
    label: "Ordini fornitori",
    icon: IconNavOrdiniFornitori,
    order: 4.5,
    showInNav: true,
    routeMatch: "prefix",
    primaryModule: "ordini_fornitori",
    expandableModules: [],
  },
  {
    key: "fatturazione",
  ...
  {
    key: "identifica_ricambio",
    href: "/identifica-ricambio",
    label: "Identifica ricambio",
    icon: IconNavIdentificaRicambio,
    order: 7.25,
    showInNav: true,
    routeMatch: "prefix",
    primaryModule: "magazzino",
