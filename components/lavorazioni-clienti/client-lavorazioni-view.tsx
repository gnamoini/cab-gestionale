...
export function ClientLavorazioniView({ listSurface: serverListSurface, listTier = "xl" }: GestionaleListPageProps) {
  ...
  useEffect(() => {
    if (!mezzoTokenParam) {
      // eslint-disable-next-line react-hooks/set-state-in-effect -- reset mezzo filter when token cleared
