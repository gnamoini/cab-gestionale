...
assert.match(editorSrc, /magazzino:fornitori/);
assert.match(editorSrc, /magazzino:produttori/);
assert.match(editorSrc, /Cerca o seleziona fornitore/);
assert.match(editorSrc, /Cerca o seleziona produttore/);
assert.doesNotMatch(editorSrc, /selectOnly/);
