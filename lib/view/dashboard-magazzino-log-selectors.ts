...
export function ricambioIdFromMagazzinoLogRow(row: LogModificaRow): string | null {
...
function logRowToMovement(
  ...
  const ricambioId = ricambioIdFromMagazzinoLogRow(row);
