...
export const NOTIFICATION_EVENT_CATALOG: readonly NotificationEventDefinition[] = [
  ...
  },
  {
    ...
    description: "Promemoria dashboard creato dall'utente (legacy)",
  },
  {
    ...
    recipients: { admin: true, ufficio: true, officina: false },
    trigger: "cab-sync",
    dedupKeyPattern: "wse:conflict:{eventId}",
    titleTemplate: "Conflitto agenda",
    description: "Overlap cross-lavorazione in Agenda Officina",
  },
  {
