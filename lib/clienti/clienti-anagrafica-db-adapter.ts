...
export function clienteAnagraficaRowsToUi(
  ...
  return {
    ...
    codiceFiscale: str(header.codice_fiscale),
    pec: str(header.pec),
    nazione: str(header.nazione) || "IT",
...
export function clienteAnagraficaUiToHeaderInsert(
  ...
  return {
    ...
    codice_fiscale: model.codiceFiscale.trim() || null,
    nazione: model.nazione.trim().toUpperCase() || "IT",
    pec: model.pec.trim() || null,
    ...
    default_vat_code_id: null,
    split_payment: false,
    natura_iva_default: null,
    default_payment_term_id: null,
    default_payment_method_id: null,
    default_account_id: null,
    default_accounting_journal_id: null,
    default_document_series_id: null,
    is_active: true,
    archived_at: null,
