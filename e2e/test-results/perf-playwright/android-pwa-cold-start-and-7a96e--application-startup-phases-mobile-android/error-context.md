...
- Name: android-pwa-cold-start.spec.ts >> android pwa cold start diagnostics >> lavorazioni navigation records application startup phases
- Location: e2e\perf\android-pwa-cold-start.spec.ts:86:7
