...
import { normalizeRicambioCodice, isAutoGeneratedRicambioCodice, resolveRicambioCodiceForPersist } from "@/lib/magazzino/ricambio-codice";
import {
...
export function ricambioFromFormLenient(
  ...
  const partial: RicambioMagazzino = {
    ...
    codiceFornitoreOriginale: resolveRicambioCodiceForPersist(f.codiceFornitoreOriginale, id),
...
export function toFormDraft(
  ...
  return syncPrezzoVenditaInForm({
    ...
    codiceFornitoreOriginale:
      isAutoGeneratedRicambioCodice(r.codiceFornitoreOriginale) ||
      r.codiceFornitoreOriginale === RICAMBIO_LENIENT_PLACEHOLDER_MARCA
        ? ""
