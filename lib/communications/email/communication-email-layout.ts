    ...
    return `
          <tr>
            <td align="center" style="padding:24px 24px 8px;border-bottom:1px solid ${t.border};">
              ...
              <div style="margin-top:4px;font-size:12px;line-height:1.4;color:${t.textMuted};font-family:${t.fontStack};">Comunicazione automatica</div>
            </td>
          </tr>`;
  }
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td valign="middle" style="font-family:${t.fontStack};">
                    ...
                    <div style="margin-top:4px;font-size:12px;line-height:1.4;color:${t.textMuted};">Comunicazione automatica</div>
                  </td>
                </tr>
              </table>
            </td>
    ...
    <tr>
      <td align="center" style="padding:28px 16px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:${t.surface};border:1px solid ${t.border};border-radius:${t.radiusLg};box-shadow:${t.shadowSm};overflow:hidden;">
          ...
          ${headerBlock(input)}
          <tr>
            <td style="padding:24px;font-family:${t.fontStack};font-size:15px;line-height:1.6;color:${t.text};white-space:pre-wrap;">${body}</td>
          </tr>
          <tr>
