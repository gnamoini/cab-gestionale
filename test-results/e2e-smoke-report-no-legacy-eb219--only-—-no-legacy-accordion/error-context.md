...
- Name: e2e\smoke\report-no-legacy.spec.ts >> Report P9 — no legacy surface >> /report is BI Center only — no legacy accordion
- Location: e2e\smoke\report-no-legacy.spec.ts:6:7
