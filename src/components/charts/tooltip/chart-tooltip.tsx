...
const ChartTooltipInner = memo(function ChartTooltipInner({
  ...
  // Plot area only; extending into margin.bottom draws past the series (e.g. under x-axis labels).
  const crosshairHeight = innerHeight;
  const crosshairFadeEdges =
