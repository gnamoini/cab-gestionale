-- Purge esplicita schede collegate a lavorazioni soft-deleted; conteggio schede storico vs attive.
...
comment on function public.delete_mezzo(uuid) is
  'Elimina mezzo dopo purge schede e lavorazioni soft-deleted collegate; blocca se restano lavorazioni attive o preventivi.';
