...
assert.match(propagaDlg, /onConfigOnly/);
assert.match(propagaDlg, /Solo configurazione\?/);
assert.match(propagaDlg, /Stato propagazioni/);
assert.match(shell, /settingsRenameEngineEntry/);
assert.match(shell, /SettingsPropagationHealthSection/);
assert.match(shell, /createPendingJobs/);
assert.match(shell, /openPropagaDialogAfterSave/);
assert.match(shell, /catalogBeforeRename/);
