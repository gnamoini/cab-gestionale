...
const magImport = fs.readFileSync(path.join(ROOT, "components/gestionale/magazzino/magazzino-import-entry.tsx"), "utf8");
assert.match(magImport, /listino_ricambi/);
...
assert.match(toolbar, /toolbarMenuOptionClass/);
