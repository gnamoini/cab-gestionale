...
/* eslint-disable react-hooks/refs -- combobox portal/listbox wiring reads option refs during render */
  ...
  const recentSection =
    recentsKey && recentValues.length > 0 && !highlightQuery.trim() && effectiveSelectOnly ? (
      <div className="border-b border-[color:var(--cab-border)] px-2 py-1.5">
        ...
        <div className="flex min-w-0 gap-1 flex-nowrap sm:flex-wrap">
