...
export function LavorazioniModalSelect({
  ...
  return (
    ...
    >
      ...
      <span
        className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-orange-500 transition-transform duration-200 ease-out group-focus-within:rotate-180"
        aria-hidden
      >
