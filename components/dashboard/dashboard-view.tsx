...
import { useDashboardRefresh } from "@/src/hooks/view/use-dashboard-refresh";
...
export function DashboardView() {
  ...
  const { refresh, busy: refreshBusy } = useDashboardRefresh();
  ...
  return (
    <>
      <GestionalePageHeaderMenu onRefresh={() => void refresh()} refreshBusy={refreshBusy} />
      {stagingRouteHint ? (
