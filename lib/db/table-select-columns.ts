...
export const PREVENTIVI_COLUMNS =
  "id, mezzo_id, lavorazione_id, cliente, totale, dettagli, stato_workflow, versione, parent_preventivo_id, current_pdf_artifact_id, pdf_sent_artifact_id, pdf_sent_hash, pdf_sent_generated_at, inviato_at, visualizzato_at, annullato_at, created_at, updated_at" as const;
...
export const ORDINI_FORNITORI_COLUMNS =
  "id, numero, status, data_ordine, data_consegna, fornitore_label, fornitore_snapshot, destinazione, destinazione_snapshot, logistica_snapshot, note, imponibile_righe, trasporto, imponibile, iva_percent, iva, totale, lavorazione_id, preventivo_id, scheda_lavorazione_id, pdf_artifact_hash, meta, created_by, updated_by, created_at, updated_at" as const;

export const ORDINI_FORNITORI_RIGHE_COLUMNS =
  "id, ordine_id, ordine, ricambio_id, codice, descrizione, quantita, quantita_ricevuta, prezzo_unitario, sconto_percent, totale_riga, meta, created_at" as const;
