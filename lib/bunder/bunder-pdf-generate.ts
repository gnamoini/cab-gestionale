...
export function bunderPdfFileName(doc: BunderCommercialDocument): string {
...
export function generateBunderPdfBytes(doc: BunderCommercialDocument, autore: string): Uint8Array {
  ...
  return new Uint8Array(j.output("arraybuffer"));
}
