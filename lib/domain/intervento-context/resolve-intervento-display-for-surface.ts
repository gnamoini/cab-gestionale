...
export function schedaIngressoFieldsFromDisplay(
  ...
  return {
    ...
    tipoAttrezzatura: display.tipoAttrezzatura.value || base.tipoAttrezzatura || "",
    marcaAttrezzatura: display.marcaAttrezzatura.value || base.marcaAttrezzatura || "",
    modelloAttrezzatura: display.modelloAttrezzatura.value || base.modelloAttrezzatura || "",
    matricola: display.matricola.value || base.matricola || "",
    nScuderia: display.nScuderia.value || base.nScuderia || "",
    oreLavoro: base.oreLavoro ?? "",
    tipoTelaio: display.tipoTelaio.value || base.tipoTelaio || "",
    marcaTelaio: display.marcaTelaio.value || base.marcaTelaio || "",
    modelloTelaio: display.modelloTelaio.value || base.modelloTelaio || "",
    vin: display.vin.value || base.vin || "",
