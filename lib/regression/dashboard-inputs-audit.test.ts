...
const healthScoreTrend = read("components/dashboard/dashboard-health-score-trend-chart.tsx");
...
assert.match(healthScoreWidget, /HealthScoreBreakdownPanel/);
assert.match(healthScoreWidget, /useOperationalHealthScoreHistory/);
assert.match(healthScoreWidget, /onCollapsedChange/);
assert.match(healthScoreRing, /export function HealthScoreBreakdownPanel/);
assert.match(healthScoreTrend, /HealthScoreWeeklyTrendChart/);
assert.match(healthScoreTrend, /HealthScoreRingLoading/);
assert.match(healthScoreRing, /reportMetricCardCompactClass/);
assert.match(healthScoreRing, /HealthScoreCard/);
assert.match(healthScoreRing, /HealthScoreSynthesisBody/);
assert.match(healthScoreRing, /HealthScoreSectionsBody/);
